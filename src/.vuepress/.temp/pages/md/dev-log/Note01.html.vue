...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>application.yml改为：</p>
...
<span class="line"><span style="--shiki-light:#22863A;--shiki-dark:#E06C75">      driver-class-name</span><span style="--shiki-light:#24292E;--shiki-dark:#ABB2BF">: </span><span style="--shiki-light:#032F62;--shiki-dark:#98C379">com.mysql.cj.jdbc.Driver</span></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li>
</ol>
<h2 id="总结" tabindex="-1"><a class="header-anchor" href="#总结"><span>总结</span></a></h2>
<ol>
<li>
<h4 id="贫血模型和充血模型" tabindex="-1"><a class="header-anchor" href="#贫血模型和充血模型"><span>贫血模型和充血模型</span></a></h4>
...
<li>
<h4 id="关于-po、vo、do、dto" tabindex="-1"><a class="header-anchor" href="#关于-po、vo、do、dto"><span>关于 PO、VO、DO、DTO</span></a></h4>
<blockquote>
...
<li>
<h4 id="为什么ddd" tabindex="-1"><a class="header-anchor" href="#为什么ddd"><span>为什么DDD</span></a></h4>
